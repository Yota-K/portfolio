  ...
  return (
    <SectionRoot heading="Career">
      <div className="flex content-between">
        <h3 className="w-1/4 pt-2 pr-4 font-bold relative after:absolute after:top-2 after:-right-[11px] after:w-5 after:h-5 after:bg-green-500 after:rounded-full">
          2018年
        </h3>
        <div className="border-l-2 px-6 pt-2 pb-6 w-[calc(100%_-_40px)]">
          <p className="lg:mb-10 mb-6">都内の私立大学を1年遅れで卒業。（留年）</p>
        </div>
      </div>
